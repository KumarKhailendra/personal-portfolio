    ...
    if (isNaN(w)) {
      try {
        if (!ta) {
          ...
          ta.innerHTML = "";
          var A = document.createTextNode("Khailendra Prasad");
          ta.appendChild(A);
          sa.appendChild(ta);
        }
        ta.style.display = "";
  ...
  function ib(h) {
    if (!jb) {
      ...
      "undefined" === typeof ra.Chart.creditHref
        ? ((h.creditHref = "aryacollege.in"),
          (h.creditText = "Khailendra Prasad"))
      ...
      if (h.creditHref && h.creditText) {
        h._creditLink ||
          ...
          h._creditLink.setAttribute("title", "Arya College of Engineering and IT"),
          V(h._creditLink, {
            outline: "none",
            margin: "0px",
            position: "absolute",
  ...
  var Ha = !1,
    ...
    ra = {
      Chart: {
        ...
        colorSet: "colorSet1",
        culture: "en",
        creditHref: "aryacollege.in",
        creditText: "Khailendra",
  ...
  v = Pa.Chart = (function () {
    ...
    function n(a, d, c) {
      ...
      (this.container =
        ...
        : window.console &&
          window.console.log(
            'Khailendra Prasad Error: Chart Container with id "' +
              this._containerId +
              '" was not found'
          );
    }
